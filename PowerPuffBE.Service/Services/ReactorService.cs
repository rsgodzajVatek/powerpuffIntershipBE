...
public interface IReactorService
{
    ...
    Task<IEnumerable<ReactorLocationsDTO>> GetReactorsWithLocations();
}
...
public class ReactorService : IReactorService
{
    ...
    public async Task<IEnumerable<ReactorLocationsDTO>> GetReactorsWithLocations()
    {
        var reactorLocations = await _reactorRepository.GetAllReactorLocations();
        return _reactorMapper.MapLocationListToDTO(reactorLocations);
    }
